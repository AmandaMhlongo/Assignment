...
namespace WebMvc.Controllers
{
    public class AddRoomsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "RoomID,RoomName,RoomType,RatePerDay,RoomStatus,NumberOfBeds")] Room room)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RoomID,RoomName,RoomType,RatePerDay,RoomStatus,NumberOfBeds")] Room room)
        {
            if (ModelState.IsValid)
            {
